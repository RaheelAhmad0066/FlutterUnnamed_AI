import 'package:aichat/GoogleAuth/Googleauth.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget _renderMessageItem(Map message, int index) {
    String role = message['role'];
    String defaultAvatar = 'assets/images/img_image7.png';
    String defaultRoleName = AIName;
    ...
    if (role == 'user') {
      ...
      defaultColor = Color.fromARGB(255, 127, 125, 125);
      defaultIcons = [];
    } else if (role == 'error') {
          ...
          customContent ??
              MarkdownBody(
                ...
                styleSheet: MarkdownStyleSheet(
                  ...
                  p: TextStyle(
                      height: 1.5, color: defaultTextColor, fontSize: 20),
                ),
              ),
        ],
      ),
